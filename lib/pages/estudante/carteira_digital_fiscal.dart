...
class CarteiraDigitalFiscal extends StatefulWidget {
  final Map<String, dynamic> estudante;
  final Map<String, dynamic> usuario;
  const CarteiraDigitalFiscal(
      {super.key, required this.estudante, required this.usuario});

  @override
  State<CarteiraDigitalFiscal> createState() => _CarteiraDigitalFiscalState();
}

class _CarteiraDigitalFiscalState extends State<CarteiraDigitalFiscal> {
        ...
        children: [
          Container(
            ...
            child: const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('MARUIM ACADÊMICO',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 14,
                        fontWeight: FontWeight.bold,
                        letterSpacing: 2)),
                Text('Transporte Universitário Municipal',
                ...
                Container(
                  ...
                  child: estudante['foto_url'] != null
                      ? ClipRRect(
                          ...
                          child: Image.network(estudante['foto_url'],
                              fit: BoxFit.cover))
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildInfo('CPF', usuario['cpf'] ?? 'N/A'),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Text('Toque para ver o verso',
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('O portador desta carteira compromete-se a:',
                    style:
                        TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                const SizedBox(height: 12),
                _buildTermo(
                    'Cancelar a reserva com antecedência mínima de 2 horas.'),
                _buildTermo(
                    'Manter conduta respeitosa com colegas e operadores.'),
                _buildTermo('Apresentar esta carteira quando solicitado.'),
                _buildTermo(
                    'O acúmulo de 100 pontos resulta em suspensão de 3 dias.'),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text('SECRETARIA DE TRANSPORTE',
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 11,
                              color: Color(0xFF1E6B3C),
                              letterSpacing: 1)),
                      const Text('Prefeitura Municipal de Maruim/SE',
                          style: TextStyle(fontSize: 10, color: Colors.grey)),
                      const SizedBox(height: 4),
                      Text(
                        'Contrato assinado em: ${widget.estudante['contrato_assinado_em']?.toString().substring(0, 10) ?? 'N/A'}',
                        style:
